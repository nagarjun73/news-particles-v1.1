...
var _carouselComponent = require("./components/carousel.component");
var _carouselComponentDefault = parcelHelpers.interopDefault(_carouselComponent);
var _bottomCardsComponent = require("./components/bottom-cards.component");
var _bottomCardsComponentDefault = parcelHelpers.interopDefault(_bottomCardsComponent);
var _sideCardsComponenr = require("./components/side-cards.componenr");
var _sideCardsComponenrDefault = parcelHelpers.interopDefault(_sideCardsComponenr);
"strict-mode";
/*
...
class App {
    ...
    constructor(){
        ...
        politics.addEventListener("click", this._renderPoliticalArticles.bind(this));
    ...
    async _renderArticlesHome() {
        ...
        try {
            const response = await fetch("https://newsapi.org/v2/top-headlines?country=in&language=en&apiKey=cbe9fa26f6424df5b56d2a45a19c3e9c");
            const data = await response.json();
            this.article = data.articles.sort(()=>Math.random() - 0.5);
            this.article.map((arts, i)=>{
                bottomCards.insertAdjacentHTML("afterbegin", (0, _bottomCardsComponentDefault.default)(arts, i));
            });
        } catch (error) {
            alert(error);
        }
    ...
    async _renderArticlesLatest(country, sort, category) {
        try {
            ...
            this.recentArticle.map((arts, i)=>{
                return rightCards.insertAdjacentHTML("afterbegin", (0, _sideCardsComponenrDefault.default)(arts, i));
            });
        } catch (error) {
            alert(error);
        }
    ...
    async _renderPoliticalArticles() {
        ...
        bottomCards.innerHTML = "";
        try {
            const response = await fetch("https://newsapi.org/v2/everything?q=political&sortBy=popularity&language=en&apiKey=cbe9fa26f6424df5b56d2a45a19c3e9c");
            const data = await response.json();
            this.article = data.articles.sort(()=>Math.random() - 0.5);
            return this.article.map((arts, i)=>{
                bottomCards.insertAdjacentHTML("afterbegin", (0, _bottomCardsComponentDefault.default)(arts, i));
    ...
    async _renderSportsArticles() {
        ...
        bottomCards.innerHTML = "";
        try {
            const response = await fetch("https://newsapi.org/v2/everything?q=sports&sortBy=popularity&language=en&apiKey=cbe9fa26f6424df5b56d2a45a19c3e9c");
            const data = await response.json();
            this.article = data.articles.sort(()=>Math.random() - 0.5);
            return this.article.map((arts, i)=>{
                bottomCards.insertAdjacentHTML("afterbegin", (0, _bottomCardsComponentDefault.default)(arts, i));
    ...
    async _renderMarketArticles() {
        ...
        bottomCards.innerHTML = "";
        try {
            const response = await fetch("https://newsapi.org/v2/everything?q=stocks&sortBy=popularity&language=en&apiKey=cbe9fa26f6424df5b56d2a45a19c3e9c");
            const data = await response.json();
            this.article = data.articles.sort(()=>Math.random() - 0.5);
            return this.article.map((arts, i)=>{
                bottomCards.insertAdjacentHTML("afterbegin", (0, _bottomCardsComponentDefault.default)(arts, i));
...
},{"bootstrap":"h36JB","./components/carousel.component":"b5Wkj","./components/bottom-cards.component":"gXWW4","./components/side-cards.componenr":"3xmK2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"h36JB":[function(require,module,exports) {
/*!
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"b5Wkj":[function(require,module,exports) {
...
exports.default = carouselHtml;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gXWW4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
<!--    </div>-->
  <div class="media-body">
      ...
      <div class="col-md-8 ">
        ...
        <p class="card-text"><small class="text-muted">${arts.publishedAt.slice(0, 10).split("-").reverse().join("-")}</small></p>
        </div>
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3xmK2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
exports.default = sideCardlHtml;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jQVXF","1SICI"], "1SICI", "parcelRequire412c")
